                                ...
                                <div className='flex justify-between items-center space-y-2'>
                                    ...
                                    <div>
                                        <select onChange={(e) => editFieldType(field.name, e.target.value)}>
                                            <option value="short_answer" className='text-black'>Short Answer</option>
                                            <option value="paragraph" className='text-black'>Paragraph</option>
                                            <option value="multichoice" className='text-black'>Multichoice</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    {field.question_type == 'multichoice' &&
                                        <div className='my-4 flex flex-col space-y-2'>
                                            <select
                                                ...
                                                {field.list.map((item) => <option key={item} value={item} className='text-black'>{item}</option>)}
                                            </select>
                                            <div className='flex space-between'>
                                                <input type="text" onChange={(e) => setTextField(e.target.value)} value={textField} className='text-black' placeholder="Agrega una opción" class='flex-1' />
